...
CREATE TABLE PF (
    ...
    CONSTRAINT PF_CPF_CK CHECK (CPF LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
...
CREATE TABLE PJ (
    ...
    CONSTRAINT PJ_CNPJ_CK CHECK (CNPJ LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
...
CREATE TABLE TELEFONE (
    ...
    DDITelefone VARCHAR(2) NOT NULL DEFAULT '55',
    DDDTelefone VARCHAR(2) NOT NULL DEFAULT '17',
	...
	CONSTRAINT TELEFONE_DDITelefone_CK CHECK (DDITelefone LIKE '[0-9][0-9]'),
    CONSTRAINT TELEFONE_DDDTelefone_CK CHECK (DDDTelefone LIKE '[0-9][0-9]'),
...
CREATE TABLE CEP (
    ...
    CONSTRAINT CEP_CEP_CK CHECK (CEP LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
...
CREATE TABLE ADVOGADO (
    ...
    CONSTRAINT ADVOGADO_OAB_CK CHECK (OAB>0 AND OAB<=9999999),
...
CREATE TABLE PROCESSO (
    ...
    NumeroDoProcesso VARCHAR(20) NOT NULL,
    ID_Vara INT NOT NULL,
    ID_Comarca INT NOT NULL,
    ID_Estado INT NOT NULL,
    ID_Area INT NOT NULL,
    ID_ProcessoApenso INT NOT NULL,
    CONSTRAINT PROCESSO_IDProcesso_PK PRIMARY KEY (IDProcesso),
    CONSTRAINT PROCESSO_NumeroDoProcesso_UN UNIQUE (NumeroDoProcesso),    
    CONSTRAINT PROCESSO_NumeroDoProcesso_CK CHECK (NumeroDoProcesso LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
    CONSTRAINT PROCESSO_ID_Vara_FK FOREIGN KEY (ID_Vara) REFERENCES VARA(IDVara),
	CONSTRAINT PROCESSO_ID_Comarca_FK FOREIGN KEY (ID_Comarca) REFERENCES COMARCA(IDComarca),
    CONSTRAINT PROCESSO_ID_Estado_FK FOREIGN KEY (ID_Estado) REFERENCES ESTADO(IDEstado),
    CONSTRAINT PROCESSO_ID_Area_FK FOREIGN KEY (ID_Area) REFERENCES AREA(IDArea),
    CONSTRAINT PROCESSO_ID_ProcessoApenso_FK FOREIGN KEY (ID_ProcessoApenso) REFERENCES PROCESSO(IDProcesso)
);
GO
...
CREATE TABLE PARTE_PROCESSO (
    ...
    CONSTRAINT PARTE_PROCESSO_PK PRIMARY KEY (ID_Pessoa, ID_Processo),    
    CONSTRAINT PARTE_PROCESSO_Polo_CK CHECK (Polo IN ('Autor', 'Reu', 'Terceiro', 'Advogado')),	
	CONSTRAINT PARTE_PROCESSO_ID_Pessoa_FK FOREIGN KEY (ID_Pessoa) REFERENCES PESSOA(IDPessoa),
    CONSTRAINT PARTE_PROCESSO_ID_Processo_FK FOREIGN KEY (ID_Processo) REFERENCES PROCESSO(IDProcesso)
);
GO
...
CREATE TABLE MODELO (
    ...
    CONSTRAINT MODELO_Tipo_CK CHECK (Tipo IN ('Peticao', 'Documento'))    
);
GO

CREATE TABLE PETICAO (
    IDPeticao INT IDENTITY(1, 1),
    DataDoProtocolo DATE NOT NULL,
    Valores VARCHAR(150) NOT NULL,
    ID_Processo INT NOT NULL,
    ID_Modelo INT NOT NULL,
    CONSTRAINT PETICAO_IDPeticao_PK PRIMARY KEY (IDPeticao),    	
	CONSTRAINT PETICAO_ID_Processo_FK FOREIGN KEY (ID_Processo) REFERENCES PROCESSO(IDProcesso),
    CONSTRAINT PETICAO_ID_Modelo_FK FOREIGN KEY (ID_Modelo) REFERENCES MODELO(IDModelo)
);
GO
...
CREATE TABLE DOCUMENTO (
    ...
    ID_Modelo INT NOT NULL,
    ID_Pessoa INT NOT NULL,
    CONSTRAINT DOCUMENTO_IDDocumento_PK PRIMARY KEY (IDDocumento),    	
	CONSTRAINT DOCUMENTO_ID_Modelo_FK FOREIGN KEY (ID_Modelo) REFERENCES MODELO(IDModelo),
    CONSTRAINT DOCUMENTO_ID_Pessoa_FK FOREIGN KEY (ID_Pessoa) REFERENCES PESSOA(IDPessoa)
);
GO

CREATE TABLE PARTE_DOCUMENTO (
    ID_Pessoa INT,
    ID_Documento INT,
    ParteNoDocumento VARCHAR(8) NOT NULL,
    CONSTRAINT PARTE_DOCUMENTO_PK PRIMARY KEY (ID_Pessoa, ID_Documento),    
    CONSTRAINT PARTE_DOCUMENTO_ParteNoDocumento_CK CHECK (ParteNoDocumento IN ('Cliente', 'Adverso', 'Advogado')),	
	CONSTRAINT PARTE_DOCUMENTO_ID_Pessoa_FK FOREIGN KEY (ID_Pessoa) REFERENCES PESSOA(IDPessoa),
    CONSTRAINT PARTE_DOCUMENTO_ID_Documento_FK FOREIGN KEY (ID_Documento) REFERENCES DOCUMENTO(IDDocumento)
);
GO

/* Criando alguns defaults após a o preenchimento das tabelas */
